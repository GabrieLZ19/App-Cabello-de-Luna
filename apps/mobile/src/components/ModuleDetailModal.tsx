    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {t("components.theoreticalModule")}
          </Text>
          <Text
            style={{
              color: "#FFFFFF",
          ...
          >
            ...
            <View style={{ marginLeft: 12, flex: 1 }}>
              ...
              >
                {module.instructorName || t("components.defaultInstructor")}
              </Text>
              <Text style={{ color: "#B0A894", fontSize: 12, marginTop: 2 }}>
                {t("components.avatarRole")}
              </Text>
            </View>
          </View>
          ...
          >
            ...
            >
              {t("components.classIncludesDesc")}
            </Text>
            ...
            >
              ...
              >
                {t("components.startClass", {
                  min: module.totalDurationMinutes || 20,
                })}
              </Text>
            </TouchableOpacity>
          </View>
